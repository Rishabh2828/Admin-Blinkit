package com.shurish.adminblinkit.auth
...
import com.shurish.adminblinkit.databinding.FragmentOtpBinding
import com.shurish.adminblinkit.models.Admins
import com.shurish.adminblinkit.viewModels.AuthViewModel
...
class OTPFragment : Fragment() {
    ...
    private fun verifyOtp(otp: String) {
        ...
        val admin  = Admins(uid = null, adminPhoneNumber = sendUserNumber)

        viewModel.signInWithPhoneAuthCredential(otp, sendUserNumber, admin)
